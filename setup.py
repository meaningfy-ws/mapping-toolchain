...
# Package PIP install location: https://github.com/meaningfy-ws/mapping-toolchain/archive/main.zip
""" """
...
version = find_version("mapping_toolchain/__init__.py")

packages = find_packages(exclude=("examples*", "tests*", "infra*"))


CONSOLE_SCRIPTS_PATH = "mapping_toolchain"

setup(
    name="mapping_toolchain",
    version=version,
    description="Mapping Toolchain is an awesome system",
    author="Meaningfy",
    author_email="eugen@meaningfy.ws",
    maintainer="Meaningfy Team",
    maintainer_email="ted-sws@meaningfy.ws",
    url="https://github.com/meaningfy-ws/mapping-toolchain",
    ...
    entry_points={
        "console_scripts": [
            ...
            f"shacl_summary_generator = {CONSOLE_SCRIPTS_PATH}.shacl_summary.entrypoints.cli.cmd_shacl_summary_generator:main",
            f"sparql_summary_generator = {CONSOLE_SCRIPTS_PATH}.sparql_summary.entrypoints.cli.cmd_sparql_summary_generator:main"
        ],
    },
