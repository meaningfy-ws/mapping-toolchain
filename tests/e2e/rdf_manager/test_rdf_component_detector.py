...
from mapping_toolchain.rdf_component_detector.services.detect_graph_component import detect_graph_components
from mapping_toolchain.rdf_component_detector.entrypoints.cli.cmd_rdf_component_detector import main as cli_main
