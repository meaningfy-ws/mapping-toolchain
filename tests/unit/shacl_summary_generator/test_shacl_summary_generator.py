...
from mapping_toolchain.shacl_summary.entrypoints.cli.cmd_shacl_summary_generator import main as cli_main
from mapping_toolchain.shacl_summary.services.shacl_summary_generator import generate_shacl_summary
