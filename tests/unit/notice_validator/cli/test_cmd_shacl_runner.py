...
from mapping_toolchain.notice_validator.entrypoints.cli.cmd_shacl_runner import main as cli_main
...
def test_cmd_shacl_runner(cli_runner, fake_mapping_suite_id, fake_mapping_suite2_id, fake_repository_path,
    ...
    with tempfile.TemporaryDirectory() as temp_folder:
        ...
        post_process(temp_mapping_suite_path, fake_mapping_suite_id)
