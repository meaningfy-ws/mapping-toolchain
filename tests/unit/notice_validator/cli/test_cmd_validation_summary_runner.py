...
from mapping_toolchain.mapping_suite_processor import DEFAULT_OUTPUT_PATH, \
    DEFAULT_TEST_SUITE_REPORT_FOLDER
from mapping_toolchain.notice_validator.entrypoints.cli.cmd_validation_summary_runner import \
    main as cli_main
