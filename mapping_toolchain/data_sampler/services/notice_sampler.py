...
from mapping_toolchain.core.adapters.cmd_runner import CmdRunner
...
class NoticeSamplerRunner(CmdRunner):
    ...
    def __init__(self, mongodb_client: MongoClient, storage_path: pathlib.Path, notice_filter: dict = None,
                 top_k: int = None):
        """
